    ...
    return (
        <>
            ...
            <div className="container-fluid">
                <NavLink activeClassName="menu_active" exact className="navbar-brand" to="/">PuneetTech</NavLink>
                ...
                <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                    <NavLink activeClassName="menu_active" exact className="nav-link" to="/services">Service</NavLink>
                    </li>
                    <li className="nav-item">
